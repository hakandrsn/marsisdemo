...
const { FETCHS_PRODUCT, FETCHS_CATEGORY, FETCH_PRODUCT, FETCH_CAGETORY, ADD_ITEM, DELETE_ITEM } = types;


export const addToCart = (obj,count) => { return { type: ADD_ITEM, payload: {...obj,count} } }
export const deleteToCart = (id) => { return { type: DELETE_ITEM, payload: id } }
